...
import com.alfin.myapplication.model.Smartphone;
...
public class MainActivity extends AppCompatActivity {
    ...
    com.alfin.myapplication.DaftarSmartphoneAdapter adapter;
    ...
    private void setupListview() {
        adapter = new com.alfin.myapplication.DaftarSmartphoneAdapter(this, daftarTransaksi);
    ...
    private void bukaFormTambahTransaksi() {
        Intent intent = new Intent(this, com.alfin.myapplication.FormSmartphoneActivity.class);
